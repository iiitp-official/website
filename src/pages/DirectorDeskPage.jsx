          ...
          <div className="p-8 md:p-12">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-8 pb-8 border-b border-gray-200 dark:border-gray-800">
              ...
              <div className="text-center md:text-left pt-2">
                <h2 className="text-3xl font-bold font-serif text-[#164e63] dark:text-blue-400 mb-2 border-b-2 border-brand-red pb-2 inline-block">Prof. Vineet Kansal</h2>
                <h3 className="text-xl text-brand-red font-bold mt-2">Director (IIIT Pune)</h3>
                <p className="text-lg text-gray-700 dark:text-gray-300 font-semibold mt-4">Indian Institute of Information Technology (IIIT) Pune</p>
                <p className="text-md text-gray-700 dark:text-gray-300 font-bold mt-4">Email: <a href="mailto:director@iiitp.ac.in" className="text-[#164e63] dark:text-blue-400 hover:underline">director@iiitp.ac.in</a></p>
              </div>
            </div>

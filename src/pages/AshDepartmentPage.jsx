...
const AshDepartmentPage = () => {
  return (
    <div className="min-h-screen transition-colors duration-200">
      <PageHeader title="Department of Applied Sciences & Humanities" />
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        <div className="bg-white/80 dark:bg-surface-dark/80 backdrop-blur-sm rounded-3xl border border-gray-200 dark:border-gray-800 p-12 shadow-sm space-y-6">
          ...
          <p className="text-gray-650 dark:text-gray-400 max-w-xl mx-auto leading-relaxed">
            We are currently updating the department portal for Applied Sciences and Humanities. Check back soon for program insights, curriculum guidelines, and faculty directory!
          </p>
        </div>
      </div>
    </div>

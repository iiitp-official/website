      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-12">
            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-indigo-900 to-purple-900 rounded-2xl shadow-xl text-white p-8 md:p-10">
                  ...
                  <AnimatePresence mode="wait">
                    {curriculum.find(c => c.semester === activeSemester)?.courses.map((course, index) => (
                      ...
                      >
                        ...
                        <td className="py-4 px-6 font-medium text-gray-800 dark:text-gray-200 group-hover:text-indigo-700 dark:group-hover:text-indigo-400 transition-colors">
                          {course.name}
                        </td>
                    ...
                    {curriculum.find(c => c.semester === activeSemester)?.totalCredits && (
                      ...
                      >
                        ...
                        <td colSpan="2" className="py-4 px-6 text-center text-indigo-700 dark:text-indigo-500 font-black text-lg">
                          {curriculum.find(c => c.semester === activeSemester).totalCredits}
                        </td>
                      </motion.tr>
                    )}

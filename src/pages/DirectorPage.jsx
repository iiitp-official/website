        ...
        <div className="bg-white dark:bg-surface-dark rounded-2xl shadow-lg border border-gray-100 dark:border-gray-800 overflow-hidden">
          <div className="p-8 md:p-12">
            ...
            <div className="space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed text-base text-justify">
              ...
              <p>
                Prior to joining IIIT Pune, Prof. Kansal served as the Director of the Institute of Engineering and Technology (IET), Lucknow. An accomplished academic and experienced administrator, he brings extensive expertise in institutional leadership, academic development, and governance.
              </p>
              <p>

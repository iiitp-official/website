      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-12">
            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-gray-800 to-black rounded-2xl shadow-xl text-white p-8 md:p-10 border border-gray-700">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-surface-dark rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 p-6 sticky top-24">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a href="/academics/phd" className="block text-gray-600 dark:text-gray-400 hover:text-accent-dark dark:hover:text-accent-dark transition-colors font-medium">
                    Ph.D.
                  </a>
                </li>
              </ul>
                  ...
                  <AnimatePresence mode="wait">
                    {curriculum.find(c => c.semester === activeSemester)?.courses.map((course, index) => (
                      ...
                      >
                        ...
                        <td className="py-4 px-6 font-medium text-gray-800 dark:text-gray-200 group-hover:text-gray-700 dark:group-hover:text-gray-400 transition-colors">
                          {course.name}
                        </td>
                    ...
                    {curriculum.find(c => c.semester === activeSemester)?.totalCredits && (
                      ...
                      >
                        ...
                        <td colSpan="2" className="py-4 px-6 text-center text-gray-700 dark:text-gray-500 font-black text-lg">
                          {curriculum.find(c => c.semester === activeSemester).totalCredits}
                        </td>
                      </motion.tr>
                    )}

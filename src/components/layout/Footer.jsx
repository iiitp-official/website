          ...
          <div className="flex items-center space-x-6">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex space-x-1">
                <span className="bg-purple-600 text-white px-2 py-1 rounded shadow-inner font-mono font-bold tracking-widest text-base">4</span>
                <span className="bg-purple-600 text-white px-2 py-1 rounded shadow-inner font-mono font-bold tracking-widest text-base">2</span>
                <span className="bg-purple-600 text-white px-2 py-1 rounded shadow-inner font-mono font-bold tracking-widest text-base">8</span>
                <span className="bg-purple-600 text-white px-2 py-1 rounded shadow-inner font-mono font-bold tracking-widest text-base">9</span>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex space-x-1">
                <span className="bg-orange-600 text-white px-2 py-1 rounded shadow-inner font-mono font-bold tracking-widest text-base">9</span>
                <span className="bg-orange-600 text-white px-2 py-1 rounded shadow-inner font-mono font-bold tracking-widest text-base">5</span>
                <span className="bg-orange-600 text-white px-2 py-1 rounded shadow-inner font-mono font-bold tracking-widest text-base">1</span>
                <span className="bg-orange-600 text-white px-2 py-1 rounded shadow-inner font-mono font-bold tracking-widest text-base">4</span>
              </div>
            </div>
          </div>
